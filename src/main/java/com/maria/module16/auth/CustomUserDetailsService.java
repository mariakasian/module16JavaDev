...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        UserData userData = getByNameOrNull(username);
        if (userData == null) {
    ...
    private UserData getByNameOrNull(String name) {
        String sql = "SELECT password, authority FROM users WHERE username = :userName";
